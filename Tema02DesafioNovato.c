...
int main() {
    ...
    printf("PIB Per Capita: %.8f\n", pibPerCapita2);
     ...
     //Compração com Lógica (if/else)

     printf("--------ATAQUE ATRIBUTO POPULAÇÃO--------\n");
     ...
     printf("--------ATAQUE ATRIBUTO PONTOS TURÍSTICOS--------\n");
     ...
     printf("--------ATAQUE ATRIBUTO DENSIDADE POPULACIONAL--------\n");
     printf("Área da Carta 1: %.2f\n", densiPop1);
     printf("Área da Carta 2: %.2f\n",  densiPop2);
     ...
     printf("--------ATAQUE ATRIBUTO PIB PER CAPITA--------\n");
     printf("Área da Carta 1: %.8f\n", pibPerCapita1);
     printf("Área da Carta 2: %.8f\n", pibPerCapita2);
