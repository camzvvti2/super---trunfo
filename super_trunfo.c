...
unsigned int populacao1;           //população da carta 1
...
poder1 = (populacao1 + area1 + PIB1 + pontos1 - densidade1 - pibpercapita1);
...
unsigned int   populacao2;               //população da carta 2
...
poder2 = (populacao2 + area2 + PIB2 + pontos2 - densidade2 - pibpercapita2);
...
printf( "o valor total da carta 1 (%u)é maior que o valor da carta 2 (%u)? %d\n",
