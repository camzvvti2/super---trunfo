...
int main() {
    ...
    float densidadePoulacional1, densidadePopulacional2; // Densidade populacional
    ...
    densidadePoulacional1 = (float)populacao1 / area1; // Calcula a densidade populacional
