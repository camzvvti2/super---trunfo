...
int main() { // Declarando variáveis a serem utilizadas char estado[2]; // Para armazenar a letra do estado char codigo[4]; // Para armazenar o código da carta char nome[20]; // Para armazenar o nome da cidade unsigned long int populacao; // Para armazenar a população (unsigned long int) int N_P_turistico; // Para armazenar o número de pontos turísticos float area, Pib; // Para armazenar a área e o PIB float densidade, pib_per_capita; // Para armazenar a densidade populacional e o PIB per capita float super_poder[2]; // Para armazenar o "Super Poder" de cada carta 
